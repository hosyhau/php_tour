							...
							<div class="book-detail">
                                <div class="panel panel-info">
                                    <div class="panel-heading">
                                        <h3 class="panel-title text-center">Tour đã đặt</h3>
                                    </div>
                                       ...
                                       <table class="table table-hover">
                                           <thead>
                                               <tr>
                                                   ...
                                                   <th width="250px">Thanh toán</th>  
                                                   <th width="200px">Xem chi tiết </th>  
                                               </tr>
                                           </thead>
                                           <tbody>
                                            <?php $i=1; foreach ($donhang as $key => $value): ?>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><a href="<?= base_url() ?>khachhang/detail/<?= $value['book_id'] ?>" type="button" class="btn btn-info">Xem</a></td>
                                               </tr>
                                            <?php $i++; endforeach ?>
